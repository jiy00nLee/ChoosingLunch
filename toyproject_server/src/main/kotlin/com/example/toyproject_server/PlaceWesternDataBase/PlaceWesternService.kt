...
@Transactional
class PlaceWesternService {

    private val placeRepository : PlaceWesternRepository

    @Autowired
    constructor(placeRepository : PlaceWesternRepository){
    ...
    fun saveAll(query: String?, userLng : Double, userLat: Double) : MutableList<String>? {
        ...
        var transed_places : List<PlaceWestern>?
    ...
    private fun mappingPlacetoPlaceDocument(place: PlaceWestern) : PlaceDocument {
